...
/*
std::string prefix = "analysisTrees/Reco_BTF_";
std::string BGOrun[BGO_CHANNELS] = {
  prefix+"BTF_530_20140505-014707_beam", // CHANNEL 0
  prefix+"BTF_538_20140505-053339_beam", // CHANNEL 1 
  prefix+"BTF_537_20140505-050526_beam", // CHANNEL 2 
  prefix+"BTF_531_20140505-020502_beam", // CHANNEL 3 
  prefix+"BTF_536_20140505-043018_beam", // CHANNEL 4 
  prefix+"BTF_533_20140505-024712_beam", // CHANNEL 5 
  prefix+"BTF_534_20140505-031520_beam", // CHANNEL 6  
  prefix+"BTF_535_20140505-035012_beam", // CHANNEL 7 
};
*/
...
int main(){
  ...
  outputdir = "BGOInterCalibration_CB";
  ...
  constantsFileName = outputdir + "/constants_CB.txt";
...
void drawHistos( const std::string& outputdir, std::vector<TH1D*> histos, const std::string& name, float yMax, float xMax ) {
  ...
  for( unsigned i=0; i<histos.size(); ++i ) {
    ...
    double thisMax = histos[i]->GetMaximum()*2; // -- multiply by rebin size
    if( thisMax>ymax_ )
      ymax_ = thisMax;
  }
