...
TF1* FitTools::fitSingleElectronPeak( const std::string& outputdir, const std::string& name, TTree* tree, int niter, float nSigma ) {
  ...
  //tree->Project( histoName.c_str(), "cef3_corr[0]+cef3_corr[1]+cef3_corr[2]+cef3_corr[3]", "(isSingleEle_scintFront && nHodoClustersX==1 && nHodoClustersY==1 && nFibres_hodoClustX[0]<2 && nFibres_hodoClustY[0]<2)");
  //tree->Project( histoName.c_str(), "cef3_corr[0]+cef3_corr[1]+cef3_corr[2]+cef3_corr[3]", "(nHodoClustersX==1 && nHodoClustersY==1 && nFibres_hodoClustX[0]<2 && nFibres_hodoClustY[0]<2)");
  //tree->Project( histoName.c_str(), "cef3_corr[0]+cef3_corr[1]+cef3_corr[2]+cef3_corr[3]", "(nHodoClustersX==1 && nHodoClustersY==1 && cef3_ok && cef3_corr_ok)");
